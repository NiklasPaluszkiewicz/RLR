...
#Answers strat2 [0.714 after 500 Rounds]
rainbow.unicorn.antistrat2 <- function(obs, i, t, game, otherD, ...) {
  if (t == 1) {
...
#Answers strat2 [0.566 after 1000 Rounds]
my.antistrat2 <- function(obs, i, t, game, otherD, ...) {
  if (t == 1) {
    return(list(a = "C", otherD = 0))
  }
  if (obs$a[[i]] == "D")
...
#Answer students to tadaa
a.tadaaa.1 = function(i,t,obs,game,c=1,plus = 2,...){ ##<---zerfetzt!!!!
  if(c == 1){
    c= c + plus
...
#Main TikTak
TikTak1 = function(obs,i,t,game,trust=1,ndef=0,ncoop=0,ntrust=0,...) {
